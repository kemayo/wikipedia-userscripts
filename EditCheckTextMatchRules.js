...
if ( !ve.getProp( mw, 'editcheck', 'TextMatchEditCheck' ) ) {
	console.log("Not loading TextMatch rules: TextMatchEditCheck isn't available");
	return;
}

if ( !mw.editcheck.TextMatchEditCheck.static.matchItems ) {
	mw.editcheck.TextMatchEditCheck.static.matchItems = {};
}

ve.extendObject( mw.editcheck.TextMatchEditCheck.static.matchItems, {
	"british-english": {
